...
async def main():
    ...
    async with make_client(token) as client:
        # Delete old ones
        try:
            await client.delete(f'{VIYA_ENDPOINT}/dataSelection/dataSelections/32de6ace-3ea6-4c21-9079-1a8784ed0b0d')
            await client.delete(f'{VIYA_ENDPOINT}/dataSelection/dataSelections/6b722cda-4d7d-432f-93b2-ad840816ff30')
        except:
            pass

        parent_ds_id = '21a65a93-8c37-4969-99b0-82ca2a260c2d'
        new_name = 'Alert 1 Galacto 9-040 Triage'
        parent_analysis_id = '818c2846-9b4e-4a86-a9b6-4282dfdb538e'
        
        # 1. Copy parent DS with EIENTERPRISE
        body = {
            "name": new_name,
        ...
        print(f"Success! Created {new_name} with ID {new_ds_id} and creationType {ds_details['creationType']}")
