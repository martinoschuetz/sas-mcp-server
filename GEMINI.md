...
- **SAS Coding Standards & Performance**: See `.agents/rules/sas.md` for our canonical guide on DATA step optimizations, PROC FedSQL usage in CAS, and macro best practices.
- **Python Development**: See `.agents/rules/python.md` for our async, structured concurrency, and performance patterns. 
