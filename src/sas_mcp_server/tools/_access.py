...
READ_ONLY_TOOLS: frozenset[str] = frozenset(
    {
        ...
        "get_data_selection_details",
        "get_forecasting_comparison_results",
        "get_forecasting_data_definition",
        "get_forecasting_filter",
        "get_forecasting_pipeline_results",
        "get_iot_analysis_details_tool",
        ...
        "list_folders_and_projects_tool",
        "list_forecasting_data_definitions",
        "list_forecasting_filters",
...
WRITE_TOOLS: frozenset[str] = frozenset(
    {
        ...
        "create_project_tool",
        "delete_data_selection_tool",
        "delete_folder_tool",
        "delete_forecasting_data_definition",
        "delete_iot_analysis_tool",
        "delete_project_tool",
        "drop_table_from_memory",
        "generate_forecast_plot",
        "generate_forecasting_timeseries_plot",
        "launch_data_selection_and_wait_tool",
        "launch_data_selection_tool",
        "reload_fqa_metadata_tool",
        ...
        "run_iot_analysis_and_wait_tool",
        "run_iot_analysis_tool",
