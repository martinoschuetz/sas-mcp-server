...
async def download_all_specs():
    ...
    # Store docu files in the parent directory if run from within docu, or use absolute path C:\Git\sas-mcp-server\docu
    docu_dir = os.path.abspath(os.path.join(script_dir, "..", "docu")) if os.path.basename(script_dir) == "docu" else r"C:\Git\sas-mcp-server\docu"
